...
- fix: sanitize top-level null optional tool arguments before Zod validation ([#281](https://github.com/zereight/gitlab-mcp/issues/281))
...
- feat: add `OAUTH_ACCEPT_EXISTING_CLIENT_ID` flag for Cloudflare MCP Portal compatibility
    - new `OAUTH_ACCEPT_EXISTING_CLIENT_ID` env var / `--oauth-accept-existing-client-id` CLI flag (default `false`)
    - when enabled, a stateless `client_id` whose TTL has lapsed (`expired`) is accepted with a synthetic stub registration that carries the original signature-verified redirect URIs, so the auth flow restarts transparently instead of returning `invalid_client`
    - **only `expired` is tolerated.** `bad_signature` (hard key rotation or forgery), `malformed`, `future_iat`, `bad_schema`, etc. continue to reject — hard rotation of `OAUTH_STATELESS_SECRET` (without `_PREVIOUS`) still invalidates every outstanding `client_id`
    - addresses [workers-oauth-provider#201](https://github.com/cloudflare/workers-oauth-provider/issues/201): Cloudflare MCP Portal caches `client_id` and cannot recover transparently from rejection
    - adds `openClientIdLenient()` to `stateless/client-id.ts` — a result-typed variant of `openClientId` that exposes the failure reason and, for `expired`, the recovered (trusted) payload
    - security: HMAC signature is still verified, so embedded redirect URIs cannot be tampered with; relaxes TTL only; DCR is open-registration so this grants no new attacker capability

#### [v2.1.0](https://github.com/zereight/gitlab-mcp/compare/v2.0.36...v2.1.0)
...
#### [v2.0.24](https://github.com/zereight/gitlab-mcp/compare/v2.0.23...v2.0.24)

- Add include_inheritance support to list_project_members [`#316`](https://github.com/zereight/gitlab-mcp/pull/316)
- feat: approve and unapprove merge requests [`#308`](https://github.com/zereight/gitlab-mcp/pull/308)
- Add cookie file reload and session warmup for proxy authenticationFix cookie warmup [`#315`](https://github.com/zereight/gitlab-mcp/pull/315)
- feat: add excluded_file_patterns parameter to get_merge_request_diffs [`#313`](https://github.com/zereight/gitlab-mcp/pull/313)
- fix: remove obsolete readonly MCP tests and update test scripts [`b72bc76`](https://github.com/zereight/gitlab-mcp/commit/b72bc7673545ca2725b6d880fa7c7d042b24920d)
- refactor: extract filterDiffsByPatterns util and add ReDoS protection [`f1adeec`](https://github.com/zereight/gitlab-mcp/commit/f1adeeceb0fc987c0baa3537c66b3b24118f64f8)
- ci: add test:mock to PR validation workflow [`78ac4a6`](https://github.com/zereight/gitlab-mcp/commit/78ac4a695f94795d6a6e03709aa4cf2d28b2f42f)

#### [v2.0.23](https://github.com/zereight/gitlab-mcp/compare/v2.0.22...v2.0.23)

> 15 January 2026

- feat(gitlab): expose merge request version tools [`#272`](https://github.com/zereight/gitlab-mcp/pull/272)
- feat(docker): add Docker support with example environment and README [`#270`](https://github.com/zereight/gitlab-mcp/pull/270)
- fix: make create_draft_note position parameter flexible [`#269`](https://github.com/zereight/gitlab-mcp/pull/269)
- feat: add CLI arguments support for configuration [`#291`](https://github.com/zereight/gitlab-mcp/pull/291)
- refactor: unify test scripts structure [`#304`](https://github.com/zereight/gitlab-mcp/pull/304)
- refactor: fix deprecated lint issues and security vulnerability [`#303`](https://github.com/zereight/gitlab-mcp/pull/303)
- fix: update dependencies for @modelcontextprotocol/sdk and add @hono/node-server [`3a07d08`](https://github.com/zereight/gitlab-mcp/commit/3a07d086ccea67d9866f4fcb7da11fd7d5140820)
- fix: use getEffectiveApiUrl and getFetchConfig in MR version functions [`bc205a5`](https://github.com/zereight/gitlab-mcp/commit/bc205a584ae9a5d356771f99eab22ab1142bc4ca)
- fix: restore original package name and remove fork references [`0c001f5`](https://github.com/zereight/gitlab-mcp/commit/0c001f54a49512f758d1496a949f36e0bf38c4da)

#### [v2.0.22](https://github.com/zereight/gitlab-mcp/compare/v2.0.21...v2.0.22)

> 4 January 2026

- ci: add missing tests to PR workflow [`#302`](https://github.com/zereight/gitlab-mcp/pull/302)
- refactor(list_merge_requests): improve code quality and docs [`#301`](https://github.com/zereight/gitlab-mcp/pull/301)
- feat: allow global merge request listing (optional project_id) [`#293`](https://github.com/zereight/gitlab-mcp/pull/293)
- chore(deps): bump qs from 6.14.0 to 6.14.1 [`#300`](https://github.com/zereight/gitlab-mcp/pull/300)

#### [v2.0.21](https://github.com/zereight/gitlab-mcp/compare/v2.0.20...v2.0.21)

> 21 December 2025

- fix: change default HOST from 0.0.0.0 to 127.0.0.1 [`#289`](https://github.com/zereight/gitlab-mcp/pull/289)
- chore(deps-dev): bump js-yaml [`#296`](https://github.com/zereight/gitlab-mcp/pull/296)
- chore(deps): bump body-parser [`#297`](https://github.com/zereight/gitlab-mcp/pull/297)
- ci: remove matrix strategy and unify Node.js to 22.21.1 in all workflows [`c8c2ac7`](https://github.com/zereight/gitlab-mcp/commit/c8c2ac75b78a84f83cc6d08a78019b6bbc9c94fb)
- chore: remove 'peer' property from multiple dependencies in package-lock.json [`6d56742`](https://github.com/zereight/gitlab-mcp/commit/6d5674216f263a719efbbdd5671b9209fe2b004f)
- chore: update step 2 image in documentation [`b235c32`](https://github.com/zereight/gitlab-mcp/commit/b235c3279ca9b7776fd35559ad012bba9490c740)

#### [v2.0.20](https://github.com/zereight/gitlab-mcp/compare/v2.0.19...v2.0.20)

> 20 December 2025

- feat: add 405 response for GET /mcp endpoint when STREAMABLE_HTTP is enabled. https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#listening-for-messages-from-the-server [`#295`](https://github.com/zereight/gitlab-mcp/pull/295)
- chore: change Docker Hub to zereight050, add workflow_dispatch [`292c801`](https://github.com/zereight/gitlab-mcp/commit/292c8018a8c64524dc46b78880c49278ddd902f8)
- chore: bump version to 2.0.20 [`49b047d`](https://github.com/zereight/gitlab-mcp/commit/49b047d2b07764d4e09b8cb65d407b73b402a235)
- chore: standardize Node.js to 22.21.1 (LTS) across all environments [`718262c`](https://github.com/zereight/gitlab-mcp/commit/718262c61a46c4a71f293f11f1bd33b70bc202d3)

#### [v2.0.19](https://github.com/zereight/gitlab-mcp/compare/v2.0.18...v2.0.19)

> 20 December 2025

- feat: add OAuth2 support and update documentation [`52661c4`](https://github.com/zereight/gitlab-mcp/commit/52661c4f219583693bea0d83a66b8cbb8a31f961)
- feat: add OAuth2 configuration examples and update documentation for Docker deployments [`1f6f2f8`](https://github.com/zereight/gitlab-mcp/commit/1f6f2f8fa25a3afc9d18bf6fec1cc6a83eae9a30)

#### [v2.0.18](https://github.com/zereight/gitlab-mcp/compare/v2.0.17...v2.0.18)

> 20 December 2025

- chore: bump version to 2.0.18 and update changelog [`55c7896`](https://github.com/zereight/gitlab-mcp/commit/55c7896a56612bad578ceb949a008f4c4cfc5c44)
- ci: upgrade npm for OIDC trusted publishing support [`cf4a57f`](https://github.com/zereight/gitlab-mcp/commit/cf4a57f18ec74a628fe8c5f027646e02c3847ae6)

#### [v2.0.17](https://github.com/zereight/gitlab-mcp/compare/v2.0.16...v2.0.17)

> 20 December 2025

- chore: bump version to 2.0.17 and update changelog [`d4cef6e`](https://github.com/zereight/gitlab-mcp/commit/d4cef6ef10f43e02e8a0a082ac92b665912e1e7f)
- ci: update npm-publish to use OIDC trusted publishing [`4eabe16`](https://github.com/zereight/gitlab-mcp/commit/4eabe16e454b481abfe473e257327e78e5d1e657)

#### [v2.0.16](https://github.com/zereight/gitlab-mcp/compare/v2.0.15...v2.0.16)

> 20 December 2025

- Revert to npm registry and add OTP support [`df5b223`](https://github.com/zereight/gitlab-mcp/commit/df5b223dfc5ea3bf88ebe73b1cc79e55716ea952)

#### [v2.0.15](https://github.com/zereight/gitlab-mcp/compare/v2.0.14...v2.0.15)

> 20 December 2025

- Switch publishing to GitHub Packages [`a2b7882`](https://github.com/zereight/gitlab-mcp/commit/a2b78820bceff9bb347b13a8978465edccd43f3b)

#### [v2.0.14](https://github.com/zereight/gitlab-mcp/compare/v2.0.13...v2.0.14)

> 20 December 2025

- Add support for dynamic GitLab API URLs and connection pooling [`#290`](https://github.com/zereight/gitlab-mcp/pull/290)
- Update changelog for v2.0.14 [`e10a3bc`](https://github.com/zereight/gitlab-mcp/commit/e10a3bcb5f15b40bb3be19bf5c3f57065103e646)
- Bump version to 2.0.14 [`124ba79`](https://github.com/zereight/gitlab-mcp/commit/124ba79f039915c9756e2143d37bfa1a6d271e39)
- Add gitignore entry for local docs [`c0d20d1`](https://github.com/zereight/gitlab-mcp/commit/c0d20d1c25813492e969ffaf5cf45700219da5d5)

#### [v2.0.13](https://github.com/zereight/gitlab-mcp/compare/v2.0.12...v2.0.13)

> 24 November 2025

- chore: bump version to 2.0.12 in package.json and update CHANGELOG [`1d9d6ae`](https://github.com/zereight/gitlab-mcp/commit/1d9d6ae3d0721aa885284a16ad8226485cdeafc9)
- chore: bump version to 2.0.13 in package.json and package-lock.json [`3f33859`](https://github.com/zereight/gitlab-mcp/commit/3f33859d7a6db680cb41c7e490eaaa3c7aa4dab2)

#### [v2.0.12](https://github.com/zereight/gitlab-mcp/compare/v2.0.11...v2.0.12)
